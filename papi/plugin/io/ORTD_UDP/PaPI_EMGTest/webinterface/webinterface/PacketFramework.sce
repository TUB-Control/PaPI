...
function [sim, PacketFramework]=ld_SendPacket(sim, PacketFramework, Signal, NValues_send, datatype, SourceName) // PARSEDOCU_BLOCK
// 
// Stream data
// 
...
// 
  ...
  if (Configuration.UnderlyingProtocoll ≃= "UDP") then
