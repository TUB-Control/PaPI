...
from papi.pyqtgraph.widgets.RemoteGraphicsView import RemoteGraphicsView

current_milli_time = lambda: int(round(time.time() * 1000))

from papi.pyqtgraph.Qt import QtCore, QtGui

class PlotPerf(vip_base):
    """
    style_codes:
...
#        self.set_widget_for_internal_usage(self.__plotWidget__)
        ...
        self.__update_intervall__ = 40  # in milliseconds
