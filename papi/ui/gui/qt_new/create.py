...
class Ui_Create(object):
    def setupUi(self, Create):
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(9, 9, 371, 332))
        ...
        self.authorLabel = QtGui.QLabel(self.formLayoutWidget)
        ...
        self.descriptionText = QtGui.QTextEdit(self.formLayoutWidget)
        ...
        self.createButton.setGeometry(QtCore.QRect(227, 486, 151, 41))
