# -*- coding: utf-8 -*-
#
# papi documentation build configuration file, created by
...
# import mock
# MOCK_MODULES = ['numpy', 'ConfigParser', 'python2_3', 'scipy', 'scipy.interpolate']
...
project = u'papi'
copyright = u'2014-2015, Control Systems, TU-Berlin'
...
version = str(pc.CORE_PAPI_VERSION)
# The full version, including alpha/beta/rc tags.
release = str(pc.CORE_PAPI_VERSION)
...
texinfo_documents = [
  ('index', 'papi', u'papi Documentation',
   u'Author', 'papi', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_copyright = u'2014-2015, Control Systems, TU-Berlin'
